var app = {
        ...
        if (!(e.scrollbarInit || (app.isMobile && e.getAttribute(app.scrollBar.skipMobileAttr)))) {
            ...
            if (((e.style.height = a), (e.scrollbarInit = !0), app.isMobile)) e.style.overflowX = "scroll";
                ...
                e.closest("." + app.sidebar.class + ":not(." + app.sidebarEnd.class + ")") && 0 !== e.closest("." + app.sidebar.class + ":not(." + app.sidebarEnd.class + ")").length
                    ? (app.sidebar.scrollBar.dom = new PerfectScrollbar(e, { wheelPropagation: t }))
    ...
    handleSidebarMenuToggle = function (e, a) {
        e.map(function (t) {
            t.onclick = function (t) {
                ...
                l.classList.contains(app.sidebar.menu.expandClass) || (l.classList.contains(app.sidebar.menu.activeClass) && !s.style.display)
                    ? (l.classList.remove(app.sidebar.menu.expandClass), l.classList.add(app.sidebar.menu.closedClass), slideToggle(s, a))
                    : (l.classList.add(app.sidebar.menu.expandClass), l.classList.remove(app.sidebar.menu.closedClass), slideToggle(s, a));
            };
        });
    },
    ...
    handleSidebarEndToggle = function () {
        ...
        [].slice.call(document.querySelectorAll("[" + app.sidebarEnd.toggleAttr + "]")).map(function (e) {
            e.onclick = function (e) {
                ...
                a.contains(app.sidebarEnd.toggledClass) || a.contains(app.sidebarEnd.collapsedClass)
                    ? a.contains(app.sidebarEnd.toggledClass)
                        ? (a.remove(app.sidebarEnd.toggledClass), a.add(app.sidebarEnd.collapsedClass))
                        : (a.remove(app.sidebarEnd.collapsedClass), a.add(app.sidebarEnd.toggledClass))
    ...
    handleSidebarMinify = function () {
        ...
        [].slice.call(document.querySelectorAll("[" + app.sidebar.minify.toggleAttr + "]")).map(function (e) {
            e.onclick = function (e) {
                ...
                var a = document.querySelector("." + app.class).classList,
                    t = !1;
                a.contains(app.sidebar.minify.toggledClass) ? a.remove(app.sidebar.minify.toggledClass) : (a.add(app.sidebar.minify.toggledClass), (t = !0)),
    ...
    handlePanelAction = function () {
        ...
        [].slice.call(document.querySelectorAll("[" + app.panel.toggle.remove.attr + "]")).map(function (a) {
            (a.onmouseover = function (a) {
                !this.hasAttribute("data-tooltip-init") && bootstrap && ((e = new bootstrap.Tooltip(this, { title: app.panel.toggle.remove.tooltipText, placement: "bottom" })).show(), this.setAttribute("data-tooltip-init", !0));
            }),
            ...
            [].slice.call(document.querySelectorAll("[" + app.panel.toggle.collapse.attr + "]")).map(function (a) {
                (a.onmouseover = function (a) {
                    !this.hasAttribute("data-tooltip-init") && bootstrap && ((e = new bootstrap.Tooltip(this, { title: app.panel.toggle.collapse.tooltipText, placement: "bottom" })).show(), this.setAttribute("data-tooltip-init", !0));
                }),
            ...
            [].slice.call(document.querySelectorAll("[" + app.panel.toggle.reload.attr + "]")).map(function (a) {
                (a.onmouseover = function (a) {
                    !this.hasAttribute("data-tooltip-init") && bootstrap && ((e = new bootstrap.Tooltip(this, { title: app.panel.toggle.reload.tooltipText, placement: "bottom" })).show(), this.setAttribute("data-tooltip-init", !0));
                }),
                    (a.onclick = function (a) {
            ...
            [].slice.call(document.querySelectorAll("[" + app.panel.toggle.expand.attr + "]")).map(function (a) {
                (a.onmouseover = function () {
                    !this.hasAttribute("data-tooltip-init") && bootstrap && ((e = new bootstrap.Tooltip(this, { title: app.panel.toggle.expand.tooltipText, placement: "bottom" })).show(), this.setAttribute("data-tooltip-init", !0));
                }),
                    (a.onclick = function (a) {
                        a.preventDefault(), e && e.hide();
                        var t = this.closest("." + app.panel.class),
                        ...
                        document.body.classList.contains(app.panel.expandClass) && t.classList.contains(app.panel.expandClass)
                            ? (document.body.classList.remove(app.panel.expandClass), t.classList.remove(app.panel.expandClass), t.removeAttribute("style"), s.removeAttribute("style"))
    ...
    handleThemePanel = function () {
        ...
        (a = document.querySelector("." + app.themePanel.class + " [" + app.themePanel.themeHeader.toggleAttr + "]")) &&
        (a.onchange = function () {
        ...
        (a = document.querySelector("." + app.themePanel.class + " [" + app.themePanel.themeHeaderFixed.toggleAttr + "]")) &&
        (a.onchange = function () {
            this.checked
        ...
        (a = document.querySelector("." + app.themePanel.class + " [" + app.themePanel.themeSidebarGrid.toggleAttr + "]")) &&
        (a.onchange = function () {
        ...
        (a = document.querySelector("." + app.themePanel.class + " [" + app.themePanel.themeSidebarFixed.toggleAttr + "]")) &&
        (a.onchange = function () {
        ...
        (a = document.querySelector("." + app.themePanel.class + " [" + app.themePanel.themeGradientEnabled.toggleAttr + "]")) &&
        (a.onchange = function () {
        ...
        (a = document.querySelector("." + app.themePanel.class + " [" + app.themePanel.toggleAttr + "]")) &&
        a.click();
        getCookie(app.themePanel.theme.cookieName) &&
        (a = document.querySelector("." + app.themePanel.class + " [" + app.themePanel.theme.toggleAttr + "][" + app.themePanel.theme.classAttr + '="' + getCookie(app.themePanel.theme.cookieName) + '"]')) &&
        a.click();
    ...
    handleUnlimitedTabsRender = function () {
            ...
            switch (
                ...
                case "next":
                    ...
                    c >= (i = i - 85) ? ((d = i - n), (u = !0)) : c < i && (d = c - n),
                        ...
                        "rtl" != s.getPropertyValue("direction")
                            ? ((m.style.marginLeft = "-" + d + "px"), u && t.classList.remove(app.unlimitedTabs.overflowRight.class), t.classList.add(app.unlimitedTabs.overflowLeft.class))
                            : ((m.style.marginRight = "-" + d + "px"), u && t.classList.remove(app.unlimitedTabs.overflowLeft.class), t.classList.add(app.unlimitedTabs.overflowRight.class)),
                        setTimeout(function () {
                ...
                case "prev":
                    ...
                    d <= 0 && (b = !0),
                        ...
                        (m.style.transitionDuration = app.animation.speed + "ms"),
                        "rtl" != s.getPropertyValue("direction")
                            ? ((m.style.marginLeft = "-" + d + "px"), t.classList.add(app.unlimitedTabs.overflowRight.class), b && t.classList.remove(app.unlimitedTabs.overflowLeft.class))
                            : ((m.style.marginRight = "-" + d + "px"), t.classList.add(app.unlimitedTabs.overflowLeft.class), b && t.classList.remove(app.unlimitedTabs.overflowRight.class)),
                        setTimeout(function () {
                            (m.style.transitionProperty = ""), (m.style.transitionDuration = "");
                        }, app.animation.speed);
            }
        ...
        var t;
        (t = [].slice.call(document.querySelectorAll("[" + app.unlimitedTabs.buttonNext.toggleAttr + "]"))) &&
        t.map(function (a) {
            a.onclick = function (a) {
                a.preventDefault(), e(this, "next");
            };
        }),
        (t = [].slice.call(document.querySelectorAll("[" + app.unlimitedTabs.buttonPrev.toggleAttr + "]"))) &&
        t.map(function (a) {
            a.onclick = function (a) {
    ...
    handleUnlimitedTopMenuRender = function () {
        ...
        function e(e, a) {
            ...
            switch (
                ...
                case "prev":
                    var g;
                    (g = -r) <= n ? (t.querySelector("." + app.topMenu.control.class + "." + app.topMenu.control.buttonPrev.class).classList.remove("show"), (p = 0)) : (p = g - n + m),
                        (t.style.transitionProperty = "height, margin, padding"),
                        (t.style.transitionDuration = app.animation.speed + "ms"),
                        "rtl" != l.getPropertyValue("direction") ? (t.style.marginLeft = "-" + p + "px") : (t.style.marginRight = "-" + p + "px"),
                        setTimeout(function () {
        ...
        function s(e) {
            ...
            s.forEach((e) => {
                ...
                a.addEventListener("mousemove", (e) => {
                    ...
                    var p = o + 1 * (s - l);
                    p <= i
                        ? ((p = i), t.querySelector("." + app.topMenu.control.class + "." + app.topMenu.control.buttonNext.class).classList.remove("show"))
                    ...
                    i > 0 && t.querySelector("." + app.topMenu.control.class + "." + app.topMenu.control.buttonNext.class).classList.remove("show"),
                        p > 0
                            ? ((p = 0), t.querySelector("." + app.topMenu.control.class + "." + app.topMenu.control.buttonPrev.class).classList.remove("show"))
        ...
        (t = document.querySelector("[" + app.topMenu.control.buttonNext.toggleAttr + "]")) &&
        (t.onclick = function (a) {
            a.preventDefault(), e(this, "next");
        }),
        (t = document.querySelector("[" + app.topMenu.control.buttonPrev.toggleAttr + "]")) &&
        (t.onclick = function (a) {
            a.preventDefault(), e(this, "prev");
        }),
            window.addEventListener("resize", function () {
    ...
    handlePageScrollClass = function () {
        ...
        /*
        if (typeof app === 'undefined' || !app.class || !app.header || !app.header.hasScrollClass) {
            console.error("app o sus propiedades necesarias no están definidos");
            return;
        }

        var targetElement = document.querySelector("." + app.class);

        if (!targetElement) {
            console.warn("Elemento con clase '" + app.class + "' no encontrado");
            return;
        }

        var updateScrollClass = function () {
            if (window.scrollY > 0) {
                targetElement.classList.add(app.header.hasScrollClass);
            } else {
                targetElement.classList.remove(app.header.hasScrollClass);
            }
        };
            ...
            e.onclick = function (e) {
                ...
                var o = setInterval(function () {
                    ...
                    if ((s && p > n && ((p = p > n ? n : p), (e.style.top = p + "px"), (e.style.bottom = "auto"), (a.style.top = "20px"), (a.style.bottom = "auto"), (t.style.top = "20px"), (t.style.bottom = "auto")), l)) {
                        ...
                        if (o > c && u) for (var m = app.sidebar.floatSubmenu.overflow.class.split(" "), b = 0; b < m.length; b++) u.classList.add(m[b]);
                    }
                }, 1);
                setTimeout(function () {
                    clearInterval(o);
                ...
                if (e && e.classList.contains(app.sidebar.minify.toggledClass)) {
                    ...
                    if (t) {
                        ...
                        if (document.querySelector(app.sidebar.floatSubmenu.id)) {
                            ...
                            if (i > m && g) for (var h = app.sidebar.floatSubmenu.overflow.class.split(" "), f = 0; f < h.length; f++) g.classList.add(h[f]);
                        ...
                        if (m - p > i)
                            g && ((g.style.top = p + "px"), (g.style.left = c + "px"), (g.style.bottom = "auto"), (g.style.right = d + "px")),
                            C && ((C.style.top = "20px"), (C.style.bottom = "auto")),
                            A && ((A.style.top = "20px"), (A.style.bottom = "auto"));
                        else {
                            var L = m - p - 21;
                            g && ((g.style.top = "auto"), (g.style.left = c + "px"), (g.style.bottom = 0), (g.style.right = d + "px")),
    ...
    handleAjaxMode = (function () {
        ...
        return {
            ...
            initDefaultUrl: function () {
                if (
                    ((this.emptyHtml = e && e.emptyHtml ? e.emptyHtml : app.ajax.error.html),
            ...
            clearElement: function () {
                ...
                /*
                var s;
                if (((s = document.getElementById(app.sidebar.floatSubmenu.id)) && s.remove(), jQuery && $.fn.DataTable))
                    try {
            ...
            renderAjax: function (a, t, s) {
                ...
                if (l) {
                    ...
                    (i.onreadystatechange = function () {
                        ...
                        (200 == i.status ? setInnerHTML(l, i.responseText) : 400 == i.status ? (console.log("There was an error 400"), setInnerHTML(l, emptyHtml)) : console.log("something else other than 200 was returned"),
    ...
    handleSetPageOption = function (e) {
        ...
        if (a) {
            ...
            var s;
            if (
                (e.appSidebarEnd && a.classList.add(app.layout.sidebarEnd.class), e.appSidebarWide && a.classList.add(app.layout.sidebarWide.class), e.appSidebarMinified && a.classList.add(app.layout.sidebarMinified.class), e.appSidebarTwo)
            )
            ...
            if ((e.appSidebarHover && a.classList.add(app.sidebar.hover.class), e.appTopMenu))
                a.classList.add(app.layout.topMenu.class), (s = document.querySelector("." + app.header.class + " [" + app.topMenu.mobile.toggleAttr + "]")) && s.classList.remove(app.helper.display.none);
            ...
            if (e.appClass) for (var l = e.appClass.split(" "), o = 0; o < l.length; o++) a.classList.add(l[o]);
            if (e.appContentClass) if ((s = document.querySelector("." + app.content.class))) for (l = e.appContentClass.split(" "), o = 0; o < l.length; o++) s.classList.add(l[o]);
    ...
    handleClearPageOption = function (e) {
        ...
        if (a) {
            ...
            if ((e.appSidebarHover && a.classList.remove(app.sidebar.hover.class), e.appTopMenu))
                a.classList.remove(app.layout.topMenu.class), (s = document.querySelector("." + app.header.class + " [" + app.topMenu.mobile.toggleAttr + "]")) && s.classList.add(app.helper.display.none);
            ...
            if (e.appContentClass) if ((s = document.querySelector("." + app.content.class))) for (var l = e.appContentClass.split(" "), o = 0; o < l.length; o++) s.classList.remove(l[o]);
            if (e.appClass) for (l = e.appClass.split(" "), o = 0; o < l.length; o++) a.classList.remove(l[o]);
    ...
    handleToggleNavbarSearch = function () {
        var e;
        (e = document.querySelector("[" + app.header.floatingForm.toggleAttr + "]")) &&
        (e.onclick = function (e) {
                ...
                (a = a.toLowerCase())
                    ...
                    e.map(function (e) {
                        ...
                        if ((t = t.toLowerCase()).search(a) > -1) {
                            var s;
                            if (
                                ((s = e.closest("." + app.sidebar.menu.itemClass)) && (s.classList.remove(app.sidebar.search.hideClass), s.classList.add(app.sidebar.search.foundClass)),
                            ...
                            if ((s = e.closest("." + app.sidebar.menu.submenu.class)))
                                if (
                                    ...
                                    (s = s.closest("." + app.sidebar.menu.hasSubClass + ":not(." + app.sidebar.search.foundClass + ")")) &&
                                    (s.classList.remove(app.sidebar.search.hideClass), s.classList.add(app.sidebar.menu.expandClass));
                        }
                    }))
                    : ((e = [].slice.call(
                        document.querySelectorAll(
    ...
    hexToRgba = function (e, a = 1, t = !1) {
        ...
        if (/^#([A-Fa-f0-9]{3}){1,2}$/.test(e))
            return 3 == (s = e.substring(1).split("")).length && (s = [s[0], s[0], s[1], s[1], s[2], s[2]]), "rgba(" + [((s = "0x" + s.join("")) >> 16) & 255, (s >> 8) & 255, 255 & s].join(",") + "," + a + ")";
        ...
        [].slice.call(document.querySelectorAll("[" + app.scrollTo.toggleAttr + "]")).map(function (e) {
            e.onclick = function (a) {
                ...
                var t = e.getAttribute(app.scrollTo.targetAttr) ? this.getAttribute(app.scrollTo.targetAttr) : this.getAttribute("href"),
                    ...
                    l = 0, //document.querySelectorAll("." + app.header.class)[0].offsetHeight,
