                        ...
                        if (!m || "single" !== m.load) {
                            ...
                            if (f && m && m.token) {
                                ...
                                ((0, a.onLCP)(_),
                                    ...
                                    (0, a.onINP)(_),
                                    (0, a.onTTFB)(_),
                                PerformanceObserver.supportedEntryTypes && PerformanceObserver.supportedEntryTypes.includes("layout-shift") && (0, a.onCLS)(_));
                                var L = m && (void 0 === m.spa || !0 === m.spa),
                                    ...
                                    P = function (r) {
                                        var a = function (e, t) {
                                                ...
                                                m &&
                                                (1 === m.r && (c.resources = []),
                                                    (0, o.sendObjectBeacon)("", c, function () {
                                                    }, !1, C),
                                                void 0 !== m.forward && void 0 !== m.forward.url && (0, o.sendObjectBeacon)("", c, function () {
                                                }, !1, m.forward.url));
                                            },
                                            c = (function (r) {
                                                var o,
                                                    ...
                                                    g = {
                                                        ...
                                                        startTime: x(),
                                                        versions: {fl: m ? m.version : "", js: "2023.10.0", timings: 1},
                                                        pageloadId: v,
                                                        location: l,
                                                    };
                                                if (null == u) {
                                                ...
                                                if (
                                                    ((g.firstPaint = M("first-paint")),
                                                        (g.firstContentfulPaint = M("first-contentful-paint")),
                                                    m && (m.icTag && (g.icTag = m.icTag), N(g, m.abtestTags), (g.siteToken = m.token)),
                                    ...
                                    R = function () {
                                        var t = (function () {
                                            ...
                                            return (
                                                m && (m.version && (r.versions.fl = m.version), m.icTag && (r.icTag = m.icTag), N(r, m.abtestTags), (r.siteToken = m.token)),
                                                b &&
                                                ["lcp", "fid", "cls", "fcp", "ttfb", "inp"].forEach(function (e) {
                                                    (r[e] = {value: -1, path: void 0}), b[e] && void 0 !== b[e].value && (r[e] = b[e]);
                                                }),
                                                    k(r),
                                                    r
                                            );
                                        })();
                                        L || ((t.resources = []), delete t.tempResources), m && (0, o.sendObjectBeacon)("", t, function () {
                                        }, !0, C);
                                    },
                                    B = function () {
                                ...
                                var A = function () {
                                    ...
                                    O = function (e) {
                                        p.push({id: v, url: e, ts: new Date().getTime()}), p.length > 3 && p.shift();
                                    };
                                L &&
                                ((s = e()),
                                    (function (t) {
                            ...
                            switch (("INP" !== e.name && (b[e.name.toLowerCase()] = {value: e.value, path: u}), e.name)) {
                                case "CLS":
                                    ...
                                    ((b.cls.element = c.largestShiftTarget),
                                        (b.cls.currentRect = null === (t = c.largestShiftSource) || void 0 === t ? void 0 : t.currentRect),
                                        (b.cls.previousRect = null === (n = c.largestShiftSource) || void 0 === n ? void 0 : n.previousRect));
                                    break;
                                case "FID":
                                ...
                                case "LCP":
                                    ...
                                    ((b.lcp.element = c.element),
                                        (b.lcp.size = null === (r = c.lcpEntry) || void 0 === r ? void 0 : r.size),
                                        (b.lcp.url = c.url),
                                        (b.lcp.rld = c.resourceLoadDelay),
                                        (b.lcp.rlt = c.resourceLoadTime),
                                        (b.lcp.erd = c.elementRenderDelay),
                                        (b.lcp.it = null === (i = c.lcpResourceEntry) || void 0 === i ? void 0 : i.initiatorType),
                                        (b.lcp.fp = null === (a = null === (o = c.lcpEntry) || void 0 === o ? void 0 : o.element) || void 0 === a ? void 0 : a.getAttribute("fetchpriority")));
                                    break;
                                case "INP":
                    ...
                    var t,
                        ...
                        p = function (e, t) {
                            var n = a(),
                                r = "navigate";
                            return (
                                d() >= 0 ? (r = "back-forward-cache") : n && (r = document.prerendering || v() > 0 ? "prerender" : document.wasDiscarded ? "restore" : n.type.replace(/_/g, "-")),
                                    {
                                        name: e,
                                        value: void 0 === t ? -1 : t,
                                        rating: "good",
                        ...
                        j = function () {
                            "interactionCount" in performance || o || (o = m("event", D, {type: "event", buffered: !0, durationThreshold: 0}));
                        },
                        q = 0,
                        H = function () {
                            return V() - q;
