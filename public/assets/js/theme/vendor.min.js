...
(function () {
    ...
    (function (t, e) {
        ...
        (x.prototype.bind = function (t, e) {
            ...
            (this.handlers[t] = this.handlers[t] || []).push(e), this.element.addEventListener(t, e, ['touchstart', 'touchmove', 'wheel'].includes(t) ? { passive: true } : false);
        }),
                    ...
                    function o(i) {
                        ...
                        if (!s(i.target, a, l)) {
                            ...
                            if (h && !i.ctrlKey) {
                                ...
                                // Intenta determinar si el evento es pasivo
                                var isEventPassive = false;
                                try {
                                ...
                                // Si el evento no es pasivo, llama a preventDefault
                                if (!isEventPassive) {
                                    try {
                                        i.preventDefault();
                                    } catch (error) {
                                        console.warn('Unable to preventDefault:', error);
                                    }
                                }
                            }
