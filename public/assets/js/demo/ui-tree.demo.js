        ...
        "core": {
            ...
            "data": [{
                ...
                "children": [{
                    ...
                    "state": {"opened": true},
                    "children": [{"text": "Another node"}, {"text": "disabled node", "state": {"disabled": true}}]
                }, {"text": "custom icon", "icon": "fa fa-cloud fa-lg text-blue"}, {
                    "text": "disabled node",
                    "state": {"disabled": true}
                }]
            }, "Root node 2"]
        ...
        "core": {
            ...
            "data": [{
                ...
                "children": [{
                    ...
                    "state": {"opened": true},
                    "children": [{"text": "Disabled node", "disabled": true}, {"text": "Another node"}]
...
var handleJstreeAjax = function () {
    $("#jstree-ajax").jstree({
        ...
        "core": {
            "themes": {"responsive": false}, "check_callback": true, "data": {
                "url": function (node) {
