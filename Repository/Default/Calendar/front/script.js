var handleCalendarDemo = function () {
    ...
    new Draggable(containerEl, {
        itemSelector: '.fc-event', eventData: function (eventEl) {
            return {title: eventEl.innerText, color: eventEl.getAttribute('data-color')};
        }
    });
    var d = new Date();
    ...
    var calendar = new FullCalendar.Calendar(calendarElm, {
        ...
        events: [{
            ...
            start: year + '-' + month + '-15',
            color: app.color.blue
        }, {title: 'Cambridge Trip', start: year + '-' + month + '-19'}, {
            ...
            color: app.color.blue
        }, {title: 'Announcement', start: year + '-' + month + '-22T15:00:00', color: app.color.red}, {
            title: 'Dinner',
